...
/**
 * Converts a value to a JSON string stream, automatically encoding any embedded Readable streams as Base64
 ...
 * @returns A Readable stream containing the JSON string
 */
